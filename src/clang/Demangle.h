...
std::optional<std::size_t> getArm64ECInsertionPointInMangledName( const std::string_view MangledName );
...
bool nonMicrosoftDemangle( std::string_view MangledName, std::string& Result, const bool CanHaveLeadingDot = true, const bool ParseParams = true );
