...
struct DumpVisitor
{
  ...
  template<class T> std::enable_if_t<std::is_unsigned<T>::value> print( T N ) { fprintf( stderr, "%llu", (unsigned long long)N ); }
...
char* ItaniumPartialDemangler::getFunctionBaseName( char* Buf, size_t* N ) const
{
  ...
  while( true )
  {
    switch( Name->getKind() )
    {
      ...
      case Node::KModuleEntity: Name = static_cast<const ModuleEntity*>( Name )->Name; continue;
...
KeepGoingLocalFunction:
  ...
  switch( Name->getKind() )
  {
    case Node::KNestedName: static_cast<const NestedName*>( Name )->Qual->print( OB ); break;
...
bool ItaniumPartialDemangler::isCtorOrDtor() const
{
  ...
  while( N )
  {
    switch( N->getKind() )
    {
      ...
      case Node::KModuleEntity: N = static_cast<const ModuleEntity*>( N )->Name; break;
    }
  }
  return false;
}
