...
private:
  ...
  std::optional<PointerAuthQualifierNode::ArgArray> demanglePointerAuthQualifier( std::string_view& MangledName );

  PointerAuthQualifierNode* createPointerAuthQualifier( std::string_view& MangledName );
  ...
  VariableSymbolNode*           demangleUntypedVariable( ArenaAllocator& Arena, std::string_view& MangledName, std::string_view VariableName );
